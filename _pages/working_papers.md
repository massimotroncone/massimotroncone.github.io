...
<div style="margin-bottom: 20px;"></div> <!-- Increase space below "Publications" -->
...
<div style="margin-bottom: 10px;">
  ...
  <em style="margin-left: 5px;">Legislative Studies Quarterly</em>
</div>

<div style="font-size: 13px; color: #808080; margin-bottom: 10px;">
  - Bryan D. Jones Best Paper Award, CAP Conference 2025
</div>

<!-- Abstract and published article links -->
<div style="display: flex; align-items: center; margin: 10px 0; color: #808080;"> <!-- Align items in one line -->
  ...
  <a href="https://onlinelibrary.wiley.com/doi/10.1111/lsq.70086" target="_blank" 
     ...
     <i class="fa fa-external-link" style="margin-right: 5px;"></i>Article
  </a>
</div>

<div id="myDIV" style="display: none; margin-top: 5px; padding: 10px; border: 1px solid #808080; background-color: #f9f9f9;">
  <p>How does unequal representation affect policymaking? Existing research shows that overrepresented districts exert disproportionate influence over public policy, yet our understanding of the underlying sources of this advantage remains limited. I argue that increased representation can independently bias policymaking via two channels: a mechanical effect, whereby additional representatives increase a district’s likelihood of shaping the legislative agenda, and a behavioral effect, whereby legislators intensify constituency-oriented effort due to intra-district competition. To test this, I leverage the quasi-experimental setting created by the electoral rule of the Italian Senate (1994–2006), which allowed districts with similar population sizes to elect either one or two senators. Using a regression discontinuity design and comprehensive data on bill (co-)sponsorship, I find evidence consistent with both channels. Examining policy outcomes, I do not find that unequal representation yields distributive benefits, but I do find suggestive evidence of a broader legislative advantage.</p>
</div>
...
<div style="display: flex; align-items: center; margin: 10px 0; color: #808080;"> <!-- Align items in one line -->
  ...
  <!-- PDF link -->
  <a href="https://osf.io/preprints/osf/nsyc3_v4" target="_blank" 
     style="text-decoration: none; background-color: #ffffff; color: #b509ac; border: 1px solid #b509ac; border-radius: 5px; padding: 0 10px; margin-right: 10px; transition: background-color 0.3s, color 0.3s; display: flex; align-items: center; justify-content: center; height: 21px; font-size: 9px;"
     onmouseover="this.style.backgroundColor='#b509ac'; this.style.color='#ffffff';" 
     onmouseout="this.style.backgroundColor=''; this.style.color='#b509ac';">
...
<div style="display: flex; align-items: center; margin: 10px 0; color: #808080;"> <!-- Align items in one line -->
  ...
  <!-- PDF link -->
  <a href="https://osf.io/preprints/osf/rgz9t_v2" target="_blank" 
     style="text-decoration: none; background-color: #ffffff; color: #b509ac; border: 1px solid #b509ac; border-radius: 5px; padding: 0 10px; margin-right: 10px; transition: background-color 0.3s, color 0.3s; display: flex; align-items: center; justify-content: center; height: 21px; font-size: 9px;"
     onmouseover="this.style.backgroundColor='#b509ac'; this.style.color='#ffffff';" 
     onmouseout="this.style.backgroundColor=''; this.style.color='#b509ac';">
     <i class="fa fa-download" style="margin-right: 5px;"></i>PDF
...
<div id="myDIV3" style="display: none; margin-top: 5px; padding: 10px; border: 1px solid #808080; background-color: #f9f9f9;">
  <p>How do unelected local leaders shape distributive politics? Religious authorities and other local leaders are often deeply embedded in the communities that receive public investment, yet many have no formal role in allocating or delivering state resources. I argue that such leaders can nonetheless shape distribution by increasing electoral returns to public investment. I test this argument using data on public works from a large-scale development program in postwar Southern Italy, exploiting variation in the election of Christian Democratic (DC) politicians and the local embeddedness of Catholic bishops. Difference-in-differences estimates show that DC politicians allocate more public works where bishops are locally embedded. These investments translate into higher DC vote shares specifically where bishops are local, with no evidence that bishops lobby for community- or Church-aligned projects or are rewarded for prior electoral support. These findings shed new light on the relationship between political intermediation and distributive politics.</p>
</div>
...
<div style="margin-bottom: 10px;">
  <span style="margin-right: 5px;">1.</span>
  <strong>Majority Preferences and Minority Cultural Transmission: Evidence from Switzerland’s Face-Covering Vote.</strong> 
...
<div style="display: flex; align-items: center; margin: 10px 0; color: #808080;">
